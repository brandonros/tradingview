    ...
    W: AsyncWrite + Unpin,
{
    ...
    pub async fn switch_timezone(&mut self, chart_session_id: &str, timezone: &str) -> SimpleResult<()> {
    ...
    pub async fn quote_add_symbols(&mut self, quote_session_id: &str, symbol: &str) -> SimpleResult<()> {
    ...
    pub async fn resolve_symbol(&mut self, chart_session_id: &str, symbol_id: &str, symbol: &str) -> SimpleResult<()> {
    ...
    pub async fn create_series(&mut self, chart_session_id: &str, series_id: &str, unk1: &str, symbol_id: &str, timeframe: &str, range: usize) -> SimpleResult<()> {
    ...
    pub async fn request_more_tickmarks(&mut self, chart_session_id: &str, series_id: &str, range: usize) -> SimpleResult<()> {
    ...
    pub async fn request_more_data(&mut self, chart_session_id: &str, series_id: &str, amount: usize) -> SimpleResult<()> {
    ...
    pub async fn quote_fast_symbols(&mut self, quote_session_id: &str, symbol: &str) -> SimpleResult<()> {
    ...
    pub async fn create_study(&mut self, chart_session_id: &str, study_id: &str, session_id: &str, series_id: &str, name: &str, value: &str) -> SimpleResult<()> {
